...
class Hook
{
    ...
    public function handle($params = [])
    {
        ...
        // 默认返回视图
            ...
            if(!empty($params['hook_name']))
            {
                ...
                {
                    case 'plugins_css' :
                        $ret = 'static/plugins/css/commononlineservice/index/style.css';
                        break;

                    case 'plugins_js' :
                        $ret = 'static/plugins/js/commononlineservice/index/style.js';
                        break;
    ...
    public function html($params = [])
    {
        ...
        if($ret['code'] == 0 && !empty($ret['data']))
        {
            ...
            return MyView('../../../plugins/view/commononlineservice/index/public/content', [
                'data'  => $ret['data'],
            ]);
        }
        return '';
