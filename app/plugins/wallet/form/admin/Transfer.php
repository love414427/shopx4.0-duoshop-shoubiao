        ...
        return [
            ...
            'form' => [
                [
                    'label'         => '发起用户',
                    'view_type'     => 'module',
                    'view_key'      => '../../../plugins/view/wallet/admin/transfer/module/send_user',
                    'grid_size'     => 'sm',
                    'is_sort'       => 1,
                    'search_config' => [
                        'form_type'             => 'input',
                ...
                [
                    'label'         => '收款用户',
                    'view_type'     => 'module',
                    'view_key'      => '../../../plugins/view/wallet/admin/transfer/module/receive_user',
                    'grid_size'     => 'sm',
                    'is_sort'       => 1,
                    'search_config' => [
                        'form_type'             => 'input',
                ...
                [
                    ...
                    'view_type'     => 'operate',
                    'view_key'      => '../../../plugins/view/wallet/admin/transfer/module/operate',
                    'align'         => 'center',
                    'fixed'         => 'right',
                ],
            ],
