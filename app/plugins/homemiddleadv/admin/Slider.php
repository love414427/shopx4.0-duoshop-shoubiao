...
class Slider extends Common
{
    ...
    public function Index($params = [])
    {
        ...
        return MyView('../../../plugins/view/homemiddleadv/admin/slider/index');
    }
    ...
    public function Detail($params = [])
    {
        ...
        MyViewAssign('common_platform_type', MyConst('common_platform_type'));
        return MyView('../../../plugins/view/homemiddleadv/admin/slider/detail');
    }
    ...
    public function SaveInfo($params = [])
    {
        ...
        MyViewAssign('data', $data);
        MyViewAssign('common_platform_type', MyConst('common_platform_type'));
        return MyView('../../../plugins/view/homemiddleadv/admin/slider/saveinfo');
    }
