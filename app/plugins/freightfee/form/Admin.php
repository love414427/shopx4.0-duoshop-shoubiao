    ...
    public function Run($params = [])
    {
        return [
            ...
            'base' => [
                ...
                'is_search'     => 1,
                'search_url'    => PluginsAdminUrl('freightfee', 'admin', 'index'),
            ...
            'form' => [
                [
                    'label'         => '名称/别名',
                    'view_type'     => 'module',
                    'view_key'      => '../../../plugins/view/freightfee/admin/admin/module/info',
                    'grid_size'     => 'sm',
                    'search_config' => [
                        'form_type'         => 'input',
                ...
                [
                    ...
                    'view_type'     => 'operate',
                    'view_key'      => '../../../plugins/view/freightfee/admin/admin/module/operate',
                    'align'         => 'center',
                    'fixed'         => 'right',
                ],
            ],
